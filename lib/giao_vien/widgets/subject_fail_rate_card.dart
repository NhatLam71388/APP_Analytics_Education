...
class SubjectFailRateCard extends StatelessWidget {
  final String title;
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              subjectName.isNotEmpty ? subjectName : 'Chưa có dữ liệu',
                              style: TextStyle(
                                color: subjectName.isNotEmpty ? color.shade900 : Colors.grey.shade500,
                                fontSize: 16,
